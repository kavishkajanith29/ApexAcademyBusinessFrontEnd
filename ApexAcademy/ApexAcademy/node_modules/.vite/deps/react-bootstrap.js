...
function useRTGTransitionProps(_ref) {
  ...
  const nodeRef = (0, import_react51.useRef)(null);
  ...
  const handleEnter = (0, import_react51.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react51.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react51.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react51.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react51.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react51.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react51.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react51.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var Modal = (0, import_react53.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime66.jsx)(import_jsx_runtime67.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime68.jsxs)(import_jsx_runtime67.Fragment, {
...
var AbstractModalHeader = React76.forwardRef(({
  ...
  const context6 = (0, import_react54.useContext)(ModalContext_default);
...
var Modal2 = React79.forwardRef(({
  ...
  const renderBackdrop = (0, import_react55.useCallback)((backdropProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasBody = React86.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React87.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime84.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React87.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React88.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React89.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React90.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react61.useCallback)((backdropProps) => (0, import_jsx_runtime87.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React91.forwardRef((props, ref) => {
...
var NavbarText = React92.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React93.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React94.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React95.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React96.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React97.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React99.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react66.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React101.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime101.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React101.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React102.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime104.jsxs)(import_jsx_runtime103.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react68.cloneElement)(children, triggerProps), (0, import_jsx_runtime102.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React103.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React103.forwardRef(({
    children,
    ...props
...
var Pagination = React104.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var TabPane = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime121.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime121.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime121.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var ToastFade = React120.forwardRef((props, ref) => (0, import_jsx_runtime125.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React124.forwardRef(({
  ...
  return (0, import_jsx_runtime129.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime129.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
