...
import {
  ...
  useUnmountEffect,
  useUpdateEffect
} from "./chunk-EVYHJB5V.js";
import {
  CSSTransition_default
} from "./chunk-WEWPMTXB.js";
import "./chunk-J4K6XE3Q.js";
import "./chunk-FQ5TEXEB.js";
import "./chunk-VFGZ7F7O.js";
...
var WindowMaximizeIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var WindowMinimizeIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Dialog = React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React5.useState(uniqueId), _React$useState2 = _slicedToArray(_React$useState, 2), idState = _React$useState2[0];
  _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
  var _React$useState5 = React5.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
  var _React$useState7 = React5.useState(props.maximized), _React$useState8 = _slicedToArray(_React$useState7, 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
  var dialogRef = React5.useRef(null);
  var maskRef = React5.useRef(null);
  var pointerRef = React5.useRef(null);
  var contentRef = React5.useRef(null);
  var headerRef = React5.useRef(null);
  var footerRef = React5.useRef(null);
  var closeRef = React5.useRef(null);
  var dragging = React5.useRef(false);
  var resizing = React5.useRef(false);
  var lastPageX = React5.useRef(null);
  var lastPageY = React5.useRef(null);
  var styleElement = React5.useRef(null);
  var attributeSelector = React5.useRef(uniqueId);
  var focusElementOnHide = React5.useRef(null);
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (props.closable) {
      ...
      var icon = props.closeIcon || React5.createElement(TimesIcon, closeButtonIconProps);
      ...
      return React5.createElement("button", closeButtonProps, headerCloseIcon, React5.createElement(Ripple, null));
    }
    return null;
  };
  var createMaximizeIcon = function createMaximizeIcon2() {
    ...
    if (!maximized) {
      icon = props.maximizeIcon || React5.createElement(WindowMaximizeIcon, maximizableIconProps);
    } else {
      icon = props.minimizeIcon || React5.createElement(WindowMinimizeIcon, maximizableIconProps);
    }
    ...
    if (props.maximizable) {
      ...
      return React5.createElement("button", maximizableButtonProps, toggleIcon, React5.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    if (props.showHeader) {
      ...
      return React5.createElement("div", headerProps, React5.createElement("div", headerTitleProps, header2), React5.createElement("div", headerIconsProps, icons, maximizeIcon, closeIcon));
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React5.createElement("div", contentProps, props.children);
  };
  var createFooter = function createFooter2() {
    ...
    return footer2 && React5.createElement("div", footerProps, footer2);
  };
  ...
  var createElement6 = function createElement7() {
    ...
    return React5.createElement(React5.Fragment, null, header2, content2, footer2, resizer);
  };
  var createDialog = function createDialog2() {
    ...
    var rootElement = React5.createElement("div", maskProps, React5.createElement(CSSTransition, _extends4({
      nodeRef: dialogRef
    }, transitionProps), React5.createElement("div", rootProps, React5.createElement(FocusTrap$1, {
      autoFocus: true
    }, contentElement))));
