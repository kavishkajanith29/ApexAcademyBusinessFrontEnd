...
const Profile = () => {
    const staffId = localStorage.getItem('LoggedUser');
    ...
    const handleLoginCheck = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:8085/api/v1/staff/login', {
                userId: staffId,
    ...
    const handleChangePassword = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8085/api/v1/staff/changePassword', null, {
                params: {
                    staffId: staffId,
